...
const projects = [
  ...
  description:"Built a serverless real-time analytics platform on AWS to ingest and process live JSON events using Lambda and store data in S3.Enabled high-performance SQL analytics using Amazon Athena with Glue-based schema discovery for structured insights.Implemented end-to-end monitoring and alerts using CloudWatch and SNS with secure IAM-based access control.",
  icon: <Bot className="w-8 h-8" />,
  status: "Live",
  ...
  color: "bg-blue-500/10 text-blue-400 border-blue-500/20"
  },
   {
    ...
    demo: "https://github.com/Thishithasai406/signSpeak.git",
    technologies: [ "Python",
    "OpenCV",
    "MediaPipe",
    "CVZone",
  ...
  },
  {
    ...
    demo: "https://www.youtube.com/watch?v=_4jg1taWC8E",
    technologies: ["Python",
    "Flask",
    "SQLite",
    "HTML",
  ...
  },
  {
    ...
    demo: "https://github.com/Thishithasai406/movie-ticket-booking-system.git",
    technologies: ["HTML5",
    "CSS3",
    "JavaScript",
    "Bootstrap",
  ...
  },
  {
    ...
    demo: "https://www.youtube.com/watch?v=8ox2GWpGuPA",
    technologies: [ "HTML5",
    "CSS3",
    "JavaScript (ES6)",
    "jsPDF",
  ...
  },
  {
    ...
    demo: "https://www.youtube.com/watch?v=yvQ2HcSeF2M",
    technologies: ["HTML5",
    "CSS3",
    "JavaScript (ES6)",
    "localStorage",
